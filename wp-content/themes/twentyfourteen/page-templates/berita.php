            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="pagination-bx col-lg-12 clearfix ">
                        <ul class="pagination">
                            <li><a href="#"><?php echo get_next_posts_link( 'Older Entries', $the_query->max_num_pages ); // display older posts link ?></a></li>
                            <li class="active"><a href="#">1</a></li>
                            <li><a href="#">2</a></li>
                            <li><a href="#">3</a></li>
                            <li><a href="#"><?php echo get_previous_posts_link('Newer Entries'); // display newer posts link ?></a></li>
                        </ul>
                    </div>
                    <?php } ?>
                    <?php else : ?>
